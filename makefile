...
C_SOURCES := main.c password.c mainmenu.c window_switcher.c newtrans.c RNG.c history.c settlement.c option.c registration.c config.c crypto.c logDB.c network.c json.c receipt.c newtrans_chooser.c newtrans_qr.c
